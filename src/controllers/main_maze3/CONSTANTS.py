...
EMERGENCY_BACKUP_MS = 1000        # Backup duration after an emergency stop (milliseconds)

# --- PATH FOLLOWING ---
NAV_WAYPOINT_STRIDE = 6          # Sample every Nth path point as a waypoint
NAV_WAYPOINT_REACH_PX = 6        # Distance (pixels) to consider a waypoint reached
NAV_GOAL_REACH_PX = 6            # Distance (pixels) to consider the final goal reached
...
COLUMN_REACH_PX = 2              # Map-distance (pixels) at which a KNOWN pillar counts as reached
